          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Provide enterprise-grade uptime monitoring to your clients with
                your own branding. Get instant alerts, detailed reports, and
                professional status pages that build trust and showcase your
                expertise.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
              {[
                ...
                <Card
                  key={index}
                  className="text-center p-6 bg-white/80 backdrop-blur-sm border-0 shadow-lg"
                >
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Built exclusively for agencies to help them offer professional
                monitoring services under their own brand.
              </p>
            </div>
              ...
              <div>
                {activeTab === "monitoring" && (
                  <div>
                    ...
                    <p className="text-gray-600 mb-6">
                      Monitor your clients' websites from 8 global locations
                      with sub-minute checking intervals. Get detailed insights
                      into performance, SSL certificates, and availability.
                    </p>
                ...
                {activeTab === "alerts" && (
                  <div>
                    ...
                    <p className="text-gray-600 mb-6">
                      Never miss a critical issue with our smart alerting
                      system. Get notified via email, SMS, or push notifications
                ...
                {activeTab === "reports" && (
                  <div>
                    ...
                    <p className="text-gray-600 mb-6">
                      Deliver professional monthly reports to your clients with
                      your branding. Showcase your value with detailed uptime
                ...
                {activeTab === "status" && (
                  <div>
                    ...
                    <p className="text-gray-600 mb-6">
                      Create stunning public status pages that build trust with
                      your clients' customers. Fully customizable with real-time
                      updates.
                    </p>
                    <ul className="space-y-3">
                      {[
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Choose the plan that scales with your agency. Additional
                features available as optional upgrades.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <Card className="relative bg-white border-2 border-indigo-500 hover:border-indigo-600 transition-all duration-300 hover:shadow-xl">
                ...
                <CardHeader className="text-center pb-8">
                  ...
                  <CardDescription className="text-gray-600 mt-2">
                    Everything you need to serve clients professionally
                  </CardDescription>
                  <div className="mt-6">
              ...
              <Card className="relative bg-white border-2 border-gray-200 hover:border-indigo-300 transition-all duration-300 hover:shadow-xl">
                <CardHeader className="text-center pb-8">
                  ...
                  <CardDescription className="text-gray-600 mt-2">
                    For large agencies with custom requirements
                  </CardDescription>
                  <div className="mt-6">
                    <span className="text-4xl font-bold text-gray-900">
                      Custom
                ...
                {[
                  {
                    ...
                    price: "$19/mo",
                    description:
                      "Auto-generated, client-facing uptime reports with your logo and colors.",
                  },
                  {
                    name: "Multi-User Logins",
                    price: "$25/mo",
                    description:
                      "Add team members with restricted roles (tech, account managers, etc).",
                  },
                  {
                    name: "30-Second Check Intervals",
                    price: "$29/mo",
                    description:
                      "Upgrade from standard 60-second pings for faster detection and response.",
                  },
                  {
                    name: "Webhook & API Access",
                    price: "$25/mo",
                    description:
                      "Trigger internal workflows or integrate with other tools (Zapier, custom).",
                  },
                ].map((addon, index) => (
                  <Card
                    key={index}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Connect with the tools your agency already uses to streamline
                your workflow.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <Card
                  key={index}
                  className="text-center p-6 bg-white border border-gray-200 hover:border-indigo-300 hover:shadow-lg transition-all duration-300"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto">
              Join hundreds of agencies already using Agency Uptime to monitor
              their clients' websites and generate additional monthly revenue.
            </p>
