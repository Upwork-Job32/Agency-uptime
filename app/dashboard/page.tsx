    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <Badge className="bg-indigo-100 text-indigo-800">Dashboard</Badge>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-gray-900">Agency Admin</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Monitor your clients' websites and track performance</p>
            </div>
            <div className="flex items-center space-x-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-600">Up</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-green-600">{stats.upSites}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-red-600">{stats.downSites}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-gray-900">{stats.avgUptime}%</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-gray-900">{stats.responseTime}ms</div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="relative">
                          ...
                          <Input placeholder="Search sites..." className="pl-10 w-64" />
                        </div>
                      ...
                      {sites.map((site) => (
                        <div key={site.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                          <div className="flex items-center space-x-4">
                            ...
                            <Badge 
                              variant={site.status === 'up' ? 'default' : 'destructive'}
                              className={site.status === 'up' ? 'bg-green-100 text-green-800' : ''}
                            >
                      ...
                      {recentAlerts.map((alert) => (
                        <div key={alert.id} className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <div>
                                <h4 className="font-medium text-gray-900">{alert.site}</h4>
                    ...
                    <div className="space-y-4">
                      {['November 2024', 'October 2024', 'September 2024'].map((month, index) => (
                        <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                          <div>
                            <h4 className="font-medium text-gray-900">{month} Report</h4>
                            <p className="text-sm text-gray-600">12 sites monitored</p>
                          </div>
                          <div className="flex items-center space-x-2">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-indigo-100 text-indigo-800">Professional</Badge>
                  </div>
                  <div className="flex items-center justify-between">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { action: 'Site added', site: 'new-client.com', time: '2h ago' },
                    { action: 'Alert sent', site: 'app.example.com', time: '5h ago' },
                    { action: 'Report generated', site: 'All sites', time: '1d ago' },
                    { action: 'Site updated', site: 'api.example.com', time: '2d ago' }
                  ].map((activity, index) => (
